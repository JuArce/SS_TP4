...
public class OvitoExporter implements Exporter {
    ...
    private static final String baseFilename = "src/main/resources/output/ovito/";
    ...
    public void open() {
        try {
            ...
            writer.writeNext(new String[]{"iteration", "t", "position", "velocity"});
            writer.close();
    ...
    public void export(List<CelestialBody> bodies) {
        try {
            ...
            for (CelestialBody body : bodies) {
                csvWriterAppender.writeNext(new String[]{body.getPosition().getX() + "", body.getPosition().getY() + ""});
            }
        } catch (Exception e) {
